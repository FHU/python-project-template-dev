...
project = os.getenv("GITHUB_REPOSITORY", "FHU Student Project")
copyright = f"{datetime.datetime.now().year}, Freed-Hardeman University"
author = os.getenv("GITHUB_REPOSITORY_OWNER", "FHU Student")
